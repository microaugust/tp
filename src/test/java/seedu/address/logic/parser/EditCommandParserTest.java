...
import static seedu.address.logic.commands.CommandTestUtil.TAG_DESC_FOLLOW_UP;
...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetId.getValue() + PHONE_DESC_BOB + TAG_DESC_HUSBAND
                + ADDRESS_DESC_AMY + NAME_DESC_AMY + TAG_DESC_FOLLOW_UP;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_HUSBAND, VALID_TAG_FOLLOW_UP).build();
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // tags
        userInput = targetId.getValue() + TAG_DESC_FOLLOW_UP;
        descriptor = new EditPersonDescriptorBuilder().withTags(VALID_TAG_FOLLOW_UP).build();
        expectedCommand = new EditCommand(targetId, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetId.getValue() + PHONE_DESC_AMY + ADDRESS_DESC_AMY
                + TAG_DESC_FRIEND + PHONE_DESC_AMY + ADDRESS_DESC_AMY + TAG_DESC_FOLLOW_UP
